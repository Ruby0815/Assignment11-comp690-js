...
let nameLength=user_name.length;
alert(`The lenght of characters of user name:  ${nameLength}`);
...
newWord=prompt("Please enter your full name");
...
let new_string=old_string.slice(0,30).toUpperCase();
alert(`The new string after extract some words in UpperCase : ${new_string}`);
